...
local function _FillOutExtraIconsMapWithSpells(extraIconsMap)
...
local function _FillOutExtraIconsMapWithTalents(extraIconsMap)
...
local function GetBaseIconTexture(index)
	local texture = gBaseIconFilenames[index];
...
---[[
	...
	GetMacroIcons(gBaseIconFilenames);

	local extraIconsMap = {}
	_FillOutExtraIconsMapWithSpells(extraIconsMap)
	_FillOutExtraIconsMapWithTalents(extraIconsMap)

	local extraIcons = {}
	extraIcons = _GetKeysArray(extraIconsMap)

	local numBaseIcons = gBaseIconFilenames and #gBaseIconFilenames or 0;
	gNumTotalIcons = 1 + #extraIcons + numBaseIcons

	local texture
	for i=1,gNumTotalIcons do
		texture = GetBaseIconTexture(i)
